...
class TeamAndroidHomePage extends StatelessWidget {
  ...
  static const List<TeamMember> members = [
    ...
    TeamMember(role: '组员 A', name: '李从周', task: '修改应用标题 projectTitle 和项目口号 projectSlogan'),
    TeamMember(role: '组员 B', name: '林赟', task: '补充 members 中的小组成员姓名与分工'), 
    TeamMember(role: '组员 C', name: '林煜练', task: '修改真机运行任务'),
    TeamMember(role: '组员 D', name: '万华江', task: '修改证据说明'),
    TeamMember(role: '组员 E', name: '刘其凯', task: '修改readme文件'),
  ];
